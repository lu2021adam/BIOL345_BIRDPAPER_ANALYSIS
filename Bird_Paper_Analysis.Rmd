...
ggplot(Purdy_Data , aes(x=Habitat, y=Richness, fill=Habitat))+
  ...
  stat_compare_means(label = "p.signif", method = "t.test", ref.group = "Core") 
...
Analysis_Variable <- c("Abundance", "Richness")
Distribution_Value <- c("W = 0.92379", "W = 0.94747")
P_Value <- c("P = 0.0298", "P = 0.1329")
Hypothesis <- c("Reject Null", "Fail to Reject Null")
Interpretation <- c("Not Normally Distributed", "Normally Distributed")
...
Analysis_Variable <- c("Abundance", "Richness")
Test_Type <- c("Wilcoxon Test", "T-Test")
Distribution_Value <- c("W = 98", "t = -2.2945")
P_Value <- c("P = 0.394", "P = 0.02919")
Hypothesis <- c("Fail to Reject Null", "Reject Null")
Interpretation <- c("No Median Difference", "Difference in Means")
